    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        androidSdk = pkgs.androidenv.composeAndroidPackages {
          ...
          # 35.0.0: AGP 7.2.1 (pinned in react-native-bindings/android/build.gradle,
          # generated by ubrn) defaults to it regardless of the app's own 36.0.0,
          # since that module never sets buildToolsVersion explicitly. Since the
          # Nix store is read-only, Gradle's SDK manager can't auto-install a
          # missing version at build time the way it would on a normal machine —
