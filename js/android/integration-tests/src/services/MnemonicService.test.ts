...
export class MnemonicService extends AppiumTestBase {
  ...
  async execute(): Promise<void> {
    ...
    // Before anything is open the demo reports so, and "Show seed" is
    ...
    // `exportMnemonic()` hands back an opaque handle; the demo's "Show seed"
    ...
    // The demo renders the phrase as a numbered grid ("1. abandon  2. …"),
