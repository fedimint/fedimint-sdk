...
[the browser SDK](../../js/web/sdk-web) is generated from. The exports
hand out this crate's own types (`Sdk`, `FederationPreview`, `FederationId`,
`Network`, `Mnemonic`, `Error`, `ErrorCode`), so a binding is a view of
this API rather than a copy that can drift.
