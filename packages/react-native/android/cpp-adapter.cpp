...
// Automated testing checks Java_com_reactnative_ReactNativeModule and fedimint_reactnative
...
Java_com_reactnative_ReactNativeModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_reactnative_ReactNativeModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
